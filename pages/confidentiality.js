            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  HelpingCloud ("we," "our," or "us") is committed to protecting your privacy and maintaining the confidentiality of your information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-gray-700 mb-4">
                  ...
                  <li>Information provided through contact forms or demo requests</li>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">13. Confidentiality Commitment</h2>
                <p className="text-gray-700 mb-4">
                  At HelpingCloud, we are committed to maintaining the confidentiality of all information shared with us. This includes:
                </p>
                <ul className="list-disc pl-6 text-gray-700 mb-4">
                  ...
                  <li>Personal data of clients and their customers</li>
                </ul>
                <p className="text-gray-700 mb-4">
                  We maintain strict confidentiality agreements with our team members and implement comprehensive security measures to protect sensitive information.
                </p>
              </section>
            </div>
